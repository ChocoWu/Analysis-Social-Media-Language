...
parser.add_argument('--train_path', action='store', dest='train_path',
                    help='Path to train data', default='./data/toy_reverse/train/data.txt')
parser.add_argument('--dev_path', action='store', dest='dev_path',
                    help='Path to dev data', default='./data/toy_reverse/dev/data.txt')
...
if opt.load_checkpoint is not None:
    ...
    # train
    t = SupervisedTrainer(loss=loss, batch_size=3,
                          checkpoint_every=50,
